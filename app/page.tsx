...
export default function SenderPage() {
    ...
    const handlePaymentAndSend = async () => {
        ...
        } catch (err) { alert("Check your Stripe setup in GitHub."); }
    };
                ...
                <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        <div style={{ position: 'relative', width: '450px', height: '350px', background: 'rgba(0,0,0,0.4)', borderRadius: '25px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', border: '1px solid #0070f3', marginBottom: '15px' }}>
                            ...
                            {/* VIBE TILES - FORCED TO TOP LAYER */}
                    ...
                    {/* SIDEBAR CONTROLS */}
                    <div style={{ position: 'absolute', right: '30px', top: '15%', display: 'flex', flexDirection: 'column', gap: '15px', alignItems: 'center' }}>
